...
public class Main {
        ...
        try {
            ...
            switch (opcaoCargo) {
                case 1:
                    ...
                    break;
                case 2:
                    tipo = TipoFuncionario.COORDENADOR;
                    break;
                case 3:
                    tipo = TipoFuncionario.ANALISTA;
                    break;
                case 4:
                    tipo = TipoFuncionario.ASSISTENTE;
                    break;
                case 5:
    ...
    private static void menuRegistrarHoras() {
        ...
        try {
            ...
            System.out.println("Digite a opção do cargo válida!");
            scanner.nextLine();
            return;
        }
    ...
    private static void menuRemoverFuncionario() {
        ...
        try {
            ...
            removerPorTipoCargo(opcaoCargo);
        } catch (InputMismatchException e){
            System.out.println("Digite uma opção válida!");
            scanner.nextLine();
        }
    ...
    private static void removerPorTipoCargo(int opcaoCargo) {
        TipoFuncionario tipo;
        switch (opcaoCargo) {
